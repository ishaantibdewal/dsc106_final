data atussum_2024;
length TUCASEID $14;
infile 'c:\atussum_2024.dat' lrecl=8192 dlm=',' missover dsd firstobs=2;
input
TUCASEID
TUFINLWGT
TRYHHCHILD
...
label t100305 = "Waiting associated with civic obligations and participation";
...
label t509999 = "Data codes, n.e.c.*";
...
;
run;
proc contents data=atussum_2024; run;
